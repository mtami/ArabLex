...
st.set_page_config(
    page_title="ArabiLex Game",
    page_icon="🏠",
    initial_sidebar_state="expanded",
    menu_items={
        "Report a bug": "https://github.com/mtami/ArabiLex/issues/new/choose",
        "About": """
         Simple game to guess secret arabic words using pre-trained [asafaya/bert-base-arabic](https://huggingface.co/asafaya/bert-base-arabic) model.\n
